...
if(isset($_POST["chess_export_btn"])){
      ...
      fputcsv($output, array('token', 'Score L1', 'Correct L1', 'Wrong L1', 'Time L1', 'Score L2', 'Correct L2', 'Wrong L2', 'Time L2', 'Score L3', 'Correct L3', 'Wrong L3', 'Time L3', 'Score L4',  'Correct L4', 'Wrong L4', 'Time L4', 'Datetime'));  
