...
if(isset($_REQUEST["score_0"]) && $_REQUEST["score_0"]!=""){
    if(isset($_REQUEST["time_0"]) && $_REQUEST["time_0"]!=""){
                            ...
                            if(isset($_REQUEST["time_3"]) && $_REQUEST["time_3"]!=""){
                                if(isset($_REQUEST["score_4"]) && $_REQUEST["score_4"]!=""){
                                    if(isset($_REQUEST["time_4"]) && $_REQUEST["time_4"]!=""){
                                        ...
                                        $score_0=(int)filter_var($_REQUEST["score_0"],FILTER_SANITIZE_STRING);
                                        $time_0=(int)filter_var($_REQUEST["time_0"],FILTER_SANITIZE_STRING);
                                        ...
                                        $query="insert into `test` (`user_id`,`score_0`,`time_0`,`score_1`,`time_1`,`score_2`,`time_2`,`score_3`,`time_3`,`score_4`,`time_4`,`datetime`) values ('{$user_id}', '{$score_0}', '{$time_0}', '{$score_1}', '{$time_1}', '{$score_2}', '{$time_2}', '{$score_3}', '{$time_3}', '{$score_4}', '{$time_4}', '{$datetime}')";
        ...
        $output='{"status":"failure", "remark":"Invalid or Incomplete time level 0 recieved"}';
    }
}else{
  $output='{"status":"failure", "remark":"Invalid or Incomplete score level 0 recieved"}';
}
