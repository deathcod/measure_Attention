                    ...
                    if(isset($_REQUEST["time_3"]) && $_REQUEST["time_3"]!=""){
                        if(isset($_REQUEST["score_4"]) && $_REQUEST["score_4"]!=""){
                            if(isset($_REQUEST["time_4"]) && $_REQUEST["time_4"]!=""){
                                ...
                                $query="insert into `card` (`user_id`,`score_1`,`time_1`,`score_2`,`time_2`,`score_3`,`time_3`,`score_4`,`time_4`,`datetime`) values ('{$user_id}', '{$score_1}', '{$time_1}', '{$score_2}', '{$time_2}', '{$score_3}', '{$time_3}', '{$score_4}', '{$time_4}', '{$datetime}')";
