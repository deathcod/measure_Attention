...
<div class="w3-container">
  <div class="w3-row w3-padding-8">
    <div class="w3-col w3-half">
      <h4>Card Game Score</h4>
    </div>
    <div class="w3-col w3-half">
      <form class="form-horizontal" action="export/card.php" method="post" name="upload_excel"   
                        enctype="multipart/form-data">
        <input type="submit" name="card_export_btn" class="w3-btn w3-right" value="Export to CSV"/>                    
      </form> 
    </div>
  </div>
  <div class="w3-row">
...
$("document").ready(function(){
  $("#title").text("Card");
  $("#card").addClass("w3-brown");
  score_list();
});

function score_list(){
  $.post("adminapi/card/score_list.php",
  {
    limit:1000,
    page:1
  },function(data){
...
$("body").on("click",".status_btn",function(){
  ...
  $.post("adminapi/card/status_update.php",
  {
    game_id:game_id
  },function(data){
    console.log(data);
